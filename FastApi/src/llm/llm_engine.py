...
def get_llm_engine():
    ...
    chat_text_qa_msgs = [
        ChatMessage(
            ...
            content=(
                ...
                "You are very helpful, responsive and are always attentive to the interests of "
                "your interlocutor."
            ),
        ),
        ChatMessage(
            ...
            content=(
                "You will be asked a question, here is some context information that may be useful "
                "to answer the question:\n"
                "---------------------\n"
                "{context_str}\n"
                "---------------------\n"
                "Given the context information about relevant films (that may appear relevant for "
                "current question) "
    ...
    query_engine = index.as_query_engine(
        response_mode="compact", text_qa_template=text_qa_template, similarity_top_k=3
    )
