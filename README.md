...
- Построение бейзлайн решения рекомендательной системы с использованием одного или нескольких популярных подходов, таких как Matrix Factorization Techniques (SVD, PCA или NMF), Collaborative Filtering и т.д.
