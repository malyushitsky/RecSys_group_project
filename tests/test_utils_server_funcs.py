...
import sys
sys.path.append('..')
from Telegram_bot.utils.server_funcs import divide_list_into_equal_groups, process_reply, get_reply
...
def test_process_reply():
    input_dict = {'Movie_box_office_revenue': 1000000, 'Actor_height': 180, 'text': 'Sample synopsis'}
    expected_output = "<b> Movie box office revenue: </b> $1,000,000\n<b> Actor height: </b> 180\n<b> Synopsis: </b> Sample synopsis\n\n"
...
def test_get_reply_with_mock():
    with requests_mock.Mocker() as m:
        mock_response = {
            'response': [{'Movie_name': 'Test Movie', 'Movie_box_office_revenue': 500000}]
        }
