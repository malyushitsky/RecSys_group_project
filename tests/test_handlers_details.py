...
import sys
sys.path.append("..")
from Telegram_bot.handlers.details import cmd_settimer, cmd_actor, cmd_film  # noqa: E402


mocked_reply_topbox = ("<b> Movie name: </b> Avatar\n<b> Movie release date year: "
                       "</b> 2009\n<b> Movie box office revenue: </b> $2,782,275,172\n\n"
                       "<b> Movie release date year: </b> 1997\n<b> Movie box office revenue: "
                       "</b> $2,185,372,302'")
...
async def test_cmd_settimer(mock_get_reply):
...
@pytest.mark.asyncio
@patch("Telegram_bot.handlers.details.get_reply")
async def test_cmd_actor(mock_get_reply):
...
@pytest.mark.asyncio
@patch("Telegram_bot.handlers.details.get_reply")
async def test_cmd_film(mock_get_reply):
